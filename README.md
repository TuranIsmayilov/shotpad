...
./Shotpad-1.0.0-x86_64.AppImage          # run it
./Shotpad-1.0.0-x86_64.AppImage --install  # menu entry and icon
```
...
```bash
./packaging/build-appimage.sh              # -> dist/Shotpad-1.0.0-x86_64.AppImage
...
```bash
./Shotpad-1.0.0-x86_64.AppImage --appimage-extract 'usr/share/licenses/*'
```
